...
const Footer = () => {
  return (
    ...
    <div class="mx-auto max-w-7xl px-4 lg:px-12 p-12 rounded-2xl bg-violet-100">
      <div
        class="flex flex-col min-[830px]:flex-row items-center justify-between gap-6 pb-10 border-b-2 border-gray-200">
        <a href="#" class="py-1.5">
          <svg xmlns="#" width="166" height="33" viewBox="0 0 166 33" fill="none">
            
            <defs>
              <linearGradient id="paint0_linear_551_319" x1="35.7811" y1="1.89063" x2="1.90742" y2="33.2568"
                gradientUnits="userSpaceOnUse">
                <stop stop-color="#7C3AED" />
                <stop offset="0.993738" stop-color="#4F46E5" />
              </linearGradient>
              <linearGradient id="paint1_linear_551_319" x1="35.7811" y1="1.89063" x2="1.90742" y2="33.2568"
                gradientUnits="userSpaceOnUse">
                <stop stop-color="#7C3AED" />
                <stop offset="0.993738" stop-color="#4F46E5" />
              </linearGradient>
        ...
        <ul class="flex flex-col sm:flex-row items-center gap-5 sm:gap-12">
          <li><a href="jaascript:;"
              class="text-lg font-normal text-gray-800 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Bookstore</a>
          </li>
          <li><a href="jaascript:;"
              class="text-lg font-normal text-gray-800 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Products</a>
          </li>
          <li><a href="jaascript:;"
              class="text-lg font-normal text-gray-800 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Resources</a>
          </li>
          <li><a href="jaascript:;"
              class="text-lg font-normal text-gray-800 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Blogs</a>
          </li>
          <li><a href="jaascript:;"
              class="text-lg font-normal text-gray-800 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Support</a>
          </li>
        </ul>
      </div>
      <div class="pt-7 flex flex-col min-[520px]:flex-row items-center justify-between gap-6">
        <ul class="flex items-center gap-9">
          <li><a href="jaascript:;"
              class="text-sm font-normal text-gray-500 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Terms</a>
          </li>
          <li><a href="jaascript:;"
              class="text-sm font-normal text-gray-500 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Privacy</a>
          </li>
          <li><a href="jaascript:;"
              class="text-sm font-normal text-gray-500 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0">Cookies</a>
          </li>
        </ul>
