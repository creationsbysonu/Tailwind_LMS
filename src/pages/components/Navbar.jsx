...
const Navbar = () => {
  return (
    <>  
		<nav class="bg-violet-200 border-gray-200 py-2.5 dark:bg-gray-900 sticky top-0 shadow-md z-50">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        <a href="/" class="flex items-center">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQomne67UBE3_diugdWHDFcBSA7JRU0_3p_A&s" class="h-6 mr-3 sm:h-9" alt="Landwind Logo"/>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <div class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">
